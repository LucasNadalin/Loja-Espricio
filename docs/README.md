...
```
- **Error Response (400)**: Caso o CPF não tenha o número correto de caractéres
```
{ 
    erro: "CPF inválido!" 
}
...
- **Descrição**: Atualiza o cliente a partir do seu id
- **Parameters**: É obrigatório fornecer o id do cliente
```
/clientes/123
```
- **Body**: É possível atualizar parcialmente e integralmente o cliente
```
{
